...
func (m *Manager) createSessionFromInfo(ctx context.Context, info *Info) (Session, error) {
	...
	case TypeCommand:
		// Command sessions are not yet implemented
		return nil, fmt.Errorf("command sessions are not yet implemented")
